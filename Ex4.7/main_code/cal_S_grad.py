import generate_data3,generate_data3np
import numpy as np
import torch
import pickle
import org_m
...
def mat_assemble2(cells,models0,models1,models2,model_gauss1,model_gauss2,S_basis,af,kk,temp,points_b,device,cupy_device):
    ...
    if temp==0:
        ...
        all_mat=org_m.A(b_matrix,db_x1_matrix,db_x2_matrix,db_x3_matrix)
