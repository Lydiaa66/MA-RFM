...
def A(b_matrix,db_x1_matrix,db_x2_matrix,db_x3_matrix):
...
def F(F_mea_b,F_mea_db_x1,F_mea_db_x2,F_mea_db_x3):
...
def L_curve(M0,M_relu1,M_relu2,M_gauss1,M_gauss2,af,mat,F,lamb_regu,cupy_device):
    iter=len(lamb_regu)
    res=np.zeros([1,iter])
