...
def ada_int(iter_int,delta,cells,nx,models,M,af,Shape,kk,F,tau_x_min,tau_x_max,tau_y_min,tau_y_max,x_left,x_right,y_below,y_upper,center_true,r_true,ana_S,points_b,lamb_regu,Qx,Qy,device,cupy_device):
    cells_store=[]
    Cells=cells
