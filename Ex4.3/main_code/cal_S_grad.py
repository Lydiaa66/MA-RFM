...
def mat_assemble2(cells,models1,models2,af,kk,temp,points_b,device,cupy_device):
    ...
    if temp==0:
        ...
        if af=="mix":
            out_cell01 = models1[0][0](all_g_p, "sigmoid")
            out_cell02 = models2[0][0](all_g_p, "Tanh")

            out_cell = torch.cat((out_cell01, out_cell02), dim=1)
        else:
            out_cell = models1[0][0](all_g_p, af)
