...
class local_rep(nn.Module):
    def __init__(self, in_features, out_features, hidden_layers, M, x_min, x_max, y_min, y_max,r_min,r_max,b1_min,b1_max,b2_min,b2_max,K_min,K_max,R_m_for_init,af,device):
...
def pre_define(Nx, Ny,M,R_m,af,tau_x_min,tau_x_max,tau_y_min,tau_y_max,r_min,r_max,b1_min,b1_max,b2_min,b2_max,K_min,K_max,device):
    models = []
    for k in range(Nx):
        model_for_x = []
        ...
        for n in range(Ny):
            ...
            model = local_rep(in_features = 2, out_features = 2, hidden_layers = 1, M = M, x_min = x_min, 
                              x_max = x_max, y_min = y_min, y_max = y_max,r_min=r_min,r_max=r_max,b1_min=b1_min,b1_max=b1_max,b2_min=b2_min,b2_max=b2_max,K_min=K_min,K_max=K_max,R_m_for_init=R_m,af=af,device=device).to(device)
