...
def test(models0,models1,models2,M,Qx,Qy,w,af,Shape1,Shape2,temp,jump,x_min,x_max,y_min,y_max,x_left,x_right,y_below,y_upper,center_true,r_true,ana_S,grad_temp,device):
    test_Qx = 2*Qx
    test_Qy = 2*Qy
    ...
    for i in range(num_batches):
        ...
        if af=="mix":
            ...
            basis_1=models1[0][0](batch_x,"sigmoid",Shape1).to(device)
            basis_2=models2[0][0](batch_x,"sigmoid",Shape2).to(device)
